...
//             {/* Overlay content */}
//             <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white text-center p-4 md:p-8 bg-black bg-opacity-20">
//               <h2 className="text-2xl bg-slate-700 md:text-3xl font-bold mb-4">{slide.title}</h2>
...
//           <a
//             href="/about"
//             className="inline-block text-slate-700 font-semibold py-3 px-6 bg-blue-400 rounded-lg shadow-md hover:bg-blue-600 transform transition duration-300"
//           >
//             Learn More
//           </a>
