...
const WhatsAppComponent = () => {
  ...
  const whatsappNumber = '+260955774867'; 
  ...
  return (
    <div className="bg-slate-700 p-6 text-white rounded-md max-w-6xl mx-auto mt-8 mb-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 max-w-xl mx-auto mt-4 mb-4">
          <label htmlFor="email" className="block text-sm font-medium">Organization</label>
          <input
            type="text"
            id="organization"
            value={email}
        ...
        <button
          type="submit"
          className="w-full bg-pink-500 hover:bg-pink-500 text-white text-xl font-bold py-2 px-4 rounded-md "
        >
          Send Message
        </button>
      </form>
