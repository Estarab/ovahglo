  ...
  return (
    <section className="text-white bg-slate-700 py-12 px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        We are a locally established, creative focused brannding company that specializes in the development and production of corporate gits, commercial printing, signage, and large format printing. We have established a strong reputation for providing high quality products that are delivered to you on time everytime. 
        </p>
